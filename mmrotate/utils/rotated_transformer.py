...
class RotatedDeformableDetrTransformer(Transformer):
    ...
    def gen_encoder_output_proposals(self, memory, memory_padding_mask,
        ...
        for lvl, (H, W) in enumerate(spatial_shapes):
            ...
            angle = torch.full((N, H, W, 1), -math.pi / 2).to(grid.device)  # le90
        ...
        # todo inverse sigmoid
        output_proposals[..., :4] = torch.log(output_proposals[..., :4]
                                              / (1 - output_proposals[..., :4]))
    ...
    def get_reference_points(spatial_shapes, valid_ratios, device):
        """Get the reference points used in decoder. 2-D point (x, y)
