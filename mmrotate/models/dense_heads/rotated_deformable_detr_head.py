...
class RotatedDeformableDETRHead(RotatedDETRHead):
    """Head of Rotated DeformDETR: Deformable DETR: Deformable Transformers for End-to-
    ...
    def get_bboxes(self,
        ...
        Returns:
            list[list[Tensor, Tensor]]: Each item in result_list is 2-tuple. \
                The first item is an (n, 9) tensor, where the first 8 columns \
                are bounding box positions (x1, y1, x2, y2, x3, y3, x4, y4) and \
                the 9-th column is a score between 0 and 1. The second item is \
